...
class Contact extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    let API_KEY = "user_irCJoR2wO4D3M6cj5xhjO";

    // YOUR EMAIL.JS TEMPLATE ID
    let TEMPLATE_ID = "template_uarpg6f";

    let Service_ID = "service_g6jy1gb"
          ...
          <Row className="padding40">
            <Col md={12} lg={6}>
              <form id="contact-form" onSubmit={this.handleSubmit}>
                ...
                <input type="text" placeholder="Subject" required name="subject" value={this.state.subject} onChange={this.inputHandler} />
                <textarea
                  rows="6"
                  cols="50"
                  placeholder="Message..."
