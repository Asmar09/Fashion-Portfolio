...
import Preview1 from "../../assets/portfolio/project01/preview.jpg";
import Preview2 from "../../assets/portfolio/project02/preview.png";
import Preview3 from "../../assets/portfolio/project03/preview.jpg";
import Preview4 from "../../assets/portfolio/project04/preview.png";
import Preview5 from "../../assets/portfolio/project05/preview.jpg";
import Preview6 from "../../assets/portfolio/project06/preview.jpg";
//Components
      ...
      <div id="portfolio">
        <div className="wrapper">
          ...
          <Row className="flex-center padding40">
            <Button label="HAVE WORK WITH ME?" target={"contact"} />
          </Row>
        </div>
      </div>
    );
